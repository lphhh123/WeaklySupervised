...
def calculate_average_maps(file_path):
    ...
    for entry in data:
        ...
        if 'test_window' in entry:
            win_data = entry['test_window']
            if 'mAPs' in win_data:
...
if __name__ == "__main__":
    ...
    target_file = "/home/yinjiaxi/wstal/WeaklySupervised-master/result/opportunity_dcase_10_3s_2026/loso_report.json"
