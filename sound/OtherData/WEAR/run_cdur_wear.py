# OtherData/WEAR/run_cdur_wear.py
# -*- coding: utf-8 -*-
import torch
...
# 2) Train one fold
# ============================================================
def train_cdur_one_fold_wear(config, fold: int, exp_name: str = "cdur_wear"):
    ...
    print(f"\n[Train CDur] fold={fold} | samples={len(train_ds)}")
...
# ============================================================
@torch.no_grad()
def test_cdur_wear(config, checkpoint_path, fold: int, test_mode: str = "test_window"):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    ...
    final_results = {"version": "CDur-WEAR-v1", "results": results_cache, "external_data": {}}
...
if __name__ == "__main__":
    config = {
        ...
        "checkpoint_dir": "/home/yinjiaxi/wstal/WeaklySupervised-master/checkpoints/wear_cdur_10_60s_2026",
        "result_root": "/home/yinjiaxi/wstal/WeaklySupervised-master/result/wear_cdur_10_60s_2026/",
