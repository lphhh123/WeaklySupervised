...
def main():
    ...
    for file_path in required_files:
        if not os.path.exists(file_path):
            raise FileNotFoundError(f"filemissing：{file_path}")
    ...
    for exp in experiments:
        ...
        print("\n" + "=" * 60)
        print(f"startexperiment：{exp_name}（model_type={model_type}, spatial_reg_weight={lam}）")
        print("=" * 60)
        ...
        print("\n" + "=" * 60)
        print(f"trainingcomplete，starttest：{exp_name}")
        print("=" * 60)
