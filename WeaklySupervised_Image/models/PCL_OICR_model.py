...
class IMU_PCL_OICR(nn.Module):
    """
    IMU  PCL/OICR （ 1D SPP）：
      input: global_feat [B, C, T]  [B, T, C], proposal_boxes [B, P, 2], labels [B, C]
      training: return losses +  score
      test: return mil_score / refine_scores
    """
    def __init__(self,
                 feat_dim,
                 num_classes,
