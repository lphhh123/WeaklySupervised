...
def _parse_args():
    parser = argparse.ArgumentParser(description="Runner for run_pcl_opportunity")
    parser.add_argument("--config", default="configs/opportunity_pcl.json", help="Path to JSON config")
