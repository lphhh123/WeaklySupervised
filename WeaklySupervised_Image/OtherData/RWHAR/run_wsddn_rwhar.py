...
def run_entry(config):
    return run_loso_wsddn(config)


def _parse_args():
    parser = argparse.ArgumentParser(description="Runner for run_wsddn_rwhar")
    parser.add_argument("--config", default="configs/rwhar_wsddn.json", help="Path to JSON config")
