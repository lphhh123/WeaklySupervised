...
def run_loso_pretrain(config: dict):
    ...
    Message：eval_loader Message test_ds（Message“Message”）

    Message：val_mode="train_subject" Message，Message Training subjects Message subject Message 1 Message val，
         test_ds Message。
    """
