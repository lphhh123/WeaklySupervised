...
def run_entry(config):
    return run_loso_oicrBUAA_hangtime(config)


def _parse_args():
    parser = argparse.ArgumentParser(description="Runner for run_oicrBUAA_hangtime")
    parser.add_argument("--config", default="configs/hangtime_oicr.json", help="Path to JSON config")
