...
from eval_xrfv2_metrics import evaluate_extra_metrics_and_plots
...
# 3) train one fold
# ============================================================
def train_oicrBUAA_one_fold_wetlab(config, fold: int, exp_name: str = "pcl_oicr_wetlab"):
    ...
    pretrain_path = os.path.join(
        ...
        f"wetlab_VGG1D_pretrained_loso_sbj_{fold}.pth"
    )
...
# ============================================================
@torch.no_grad()
def test_oicrBUAA_wetlab(config, checkpoint_path, fold: int, test_mode: str = "test_window"):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    ...
    with open(pred_path, "w", encoding="utf-8") as f:
        json.dump({"version": "OICRBUAA-wetlab-v1.0", "results": results, "external_data": {}},
...
# 5) multi-fold runner
# ============================================================
def run_loso_oicrBUAA_wetlab(config):
    ...
    for i, fold in enumerate(folds):
        ...
        ckpt = train_oicrBUAA_one_fold_wetlab(
            config, fold, exp_name=config.get("exp_name", "pcl_oicr_wetlab")
        )

        mAPs_w, avg_w, pred_w = test_oicrBUAA_wetlab(config, ckpt, fold=fold, test_mode="test_window")
        mAPs_f, avg_f, pred_f = test_oicrBUAA_wetlab(config, ckpt, fold=fold, test_mode="test_full")
...
if __name__ == "__main__":
    config = {
        ...
        "checkpoint_dir": "/home/lipei/project/WSDDN/checkpoints/WETLAB/oicrBUAA_0112",
        "result_root": "/home/lipei/project/WSDDN/test_results/WETLAB/oicrBUAA_0112",
        ...
        "testing": {
            "test_window_proposals":800,
            "test_full_proposals": 8000,
            "conf_thresh": 0.0,
            "nms_sigma": 0.5,
            "top_k": 200,
    ...
    run_loso_oicrBUAA_wetlab(config)
