...
def run_entry(config):
    return run_loso_oicrBUAA_wetlab(config)


def _parse_args():
    parser = argparse.ArgumentParser(description="Runner for run_oicrBUAA_wetlab")
    parser.add_argument("--config", default="configs/wetlab_oicr.json", help="Path to JSON config")
