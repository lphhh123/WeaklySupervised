...
def run_loso_pretrain(config: dict):
    ...
    for fold in range(config.get("num_folds", 15)):  # ★15 folds
        ...
        train_ds_full = WetlabDataset_10s(
        ...
        save_backbone_path = os.path.join(out_dir, f"wetlab_{model_name}_pretrained_loso_sbj_{fold}.pth")
...
if __name__ == "__main__":
    config = {
        "dataset_dir": "data/wetlab/",
        "out_dir": "OtherData/WETLAB/pre_train",
