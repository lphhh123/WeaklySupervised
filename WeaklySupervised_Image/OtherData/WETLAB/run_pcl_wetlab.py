...
# train one fold
# ============================================================
def train_pcl_oicr_one_fold_wetlab(config, fold: int, exp_name: str = "pcl_oicr_rwhar"):
    ...
    # ---- load backbone (fold-specific pretrain) ----
...
# ============================================================
@torch.no_grad()
def test_pcl_oicr_wetlab(config, checkpoint_path, fold: int, test_mode: str = "test_window"):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    ...
    with open(pred_path, "w", encoding="utf-8") as f:
        json.dump({"version": "PCL-OICR-wetlab-v1.0", "results": results, "external_data": {}},
...
# 5) multi-fold runner
# ============================================================
def run_loso_pcl_oicr_wetlab(config):
    ...
    for i, fold in enumerate(folds):
        ...
        ckpt = train_pcl_oicr_one_fold_wetlab(
            config, fold, exp_name=config.get("exp_name", "pcl_oicr_opportunity")
        )

        mAPs_w, avg_w, pred_w = test_pcl_oicr_wetlab(config, ckpt, fold=fold, test_mode="test_window")
        mAPs_f, avg_f, pred_f = test_pcl_oicr_wetlab(config, ckpt, fold=fold, test_mode="test_full")
...
if __name__ == "__main__":
    config = {
        ...
        "checkpoint_dir": "/home/lipei/project/WSDDN/checkpoints/WETLAB/2022/pcl_01",
        "result_root": "/home/lipei/project/WSDDN/test_results/WETLAB/2022/pcl_01",
        ...
        "testing": {
            "test_window_proposals":2000,
            "test_full_proposals": 10000,
            "conf_thresh": 0.0,
            "nms_sigma": 0.5,
            "top_k": 200,
    ...
    run_loso_pcl_oicr_wetlab(config)
