...
def run_entry(config):
    return run_loso_pcl_oicr_wetlab(config)


def _parse_args():
    parser = argparse.ArgumentParser(description="Runner for run_pcl_wetlab")
    parser.add_argument("--config", default="configs/wetlab_pcl.json", help="Path to JSON config")
