...
def plot_sbj0_action_sequence(file_path, dataset_name="Opportunity"):
    """
    Messagesbj_0Message
    :param file_path: MessageJSONMessage
    :param dataset_name: Message（Message）
    """

    if not os.path.exists(file_path):
        raise FileNotFoundError(f"Message，Message：{file_path}")
    ...
    try:
        ...
        raise KeyError(f"Message，Message：{e}，Messagedatabase/sbj_0/duration/annotations")
