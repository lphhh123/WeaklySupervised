...
def run_all_re_inference():
    ...
    for seed in SEEDS:
        print(f"\nStarting re-inference for seed: {seed}")
        ...
        for fold in FOLDS:
            ...
            if not os.path.exists(ckpt_path):
                print(f"   Warning: skipping Fold {fold}, checkpoint missing")
                continue
            ...
            try:
                ...
                print(f"   Fold {fold} inference failed: {e}")

    print("\nDual-mode inference completed for all seeds.")
    print(f"See directory: {RESULTS_ROOT}")
