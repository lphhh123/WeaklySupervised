...
def parse_value_from_str(s):
    """
    Message "12.34 ± 1.00" Message，Message
    """
    try:
        if "±" in s:
...
def main():
    print(f"🚀 Message (Target: {TARGET_FILE})")
    print(f"📂 Message: {PROJECT_ROOT}\n")
    ...
    print(table.table)
    print("\nMessage: Time Message, Memory Message。")
