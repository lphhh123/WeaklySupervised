...
class WeaklySupervisedXRFV2DatasetTrain(Dataset):
    ...
    def _load_stats(self, modality='imu'):
        ...
        if modality not in stats:
            raise KeyError(f"global_stats.json Message {modality} Message")
        return (
    ...
    def _preprocess_imu(self, sample_30s_np):
        ...
        -> [5, 6, 2048] -> [30, 2048]，Message imu Message global_mean/_std Message
        """
    ...
    def _preprocess_airpods(self, sample_air_np):
        ...
        Message(3:6) + Message(6:9) Message6Message:
        -> [2048, 6] -> [6, 2048]，Message airpods Message global_mean/_std Message
        """
