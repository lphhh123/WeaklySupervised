...
class OpportunityDataset_3s(Dataset):
    ...
    - Reconstruct continuous 30Hz raw [T,113] from processed/.../sbj_k.npy
    - 3s window (stride 50%)
    - If the window center frame is inside a GT segment -> pick the label with the largest overlap
        ...
        if self.normalize:
            ...
            if fold_id is None:
                raise RuntimeError(
                    ...
                    f"Please keep names like loso_sbj_0.json"
                )
