...
def calculate_average_metrics():
    ...
    valid_files_count = 0
    print(f"Message: {base_dir}")

    for file_path in file_paths:
        if not os.path.exists(file_path):
            print(f"Message: Message {file_path}，Message。")
            continue
        ...
        try:
            ...
            print(f"Message {file_path} Message: {e}")
    ...
    try:
        ...
        print(f"Message categories: {list(final_results.keys())}")
    except Exception as e:
        print(f"Message: {e}")
