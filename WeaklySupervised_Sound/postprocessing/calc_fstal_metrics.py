...
def get_config_from_file(pred_path):
    """
    Read dataset_name and init_rand_seed from cfg.txt under PRED_PATH.
    """
...
def main():
    ...
    print(f"Starting evaluation for dataset: {dataset_name} (Seed: {seed})")
    print(f"Config path: {PRED_PATH}")
    print(f"Prediction CSV path: {csv_dir}")
