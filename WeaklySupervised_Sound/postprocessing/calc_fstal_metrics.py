...
def get_config_from_file(pred_path):
    """
    Message PRED_PATH Message cfg.txt Message dataset_name Message init_rand_seed
    """
...
def main():
    ...
    print(f"Message Dataset: {dataset_name} (Seed: {seed})")
    print(f"Message: {PRED_PATH}")
    print(f"MessageCSVMessage: {csv_dir}")
    print(f"Message: {ANNO_PATH}")
    print("-" * 60)
