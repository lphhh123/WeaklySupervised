...
dataset = 'wear'
algorithm = 'actionformer'
experiment_type = 'unchunked'
chunk_size = 5
if experiment_type == 'chunked':
    path_to_preds = ['experiments/{}/{}/{}/{}'.format(experiment_type, dataset, algorithm, str(chunk_size))]
else:
    path_to_preds = '/home/yinjiaxi/wstal/tal_for_har/logs/actionformer/2025-12-03 12:45:25_/unprocessed_results/'
