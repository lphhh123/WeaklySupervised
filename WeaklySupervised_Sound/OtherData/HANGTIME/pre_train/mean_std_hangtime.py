...
def npy_windows_to_raw_frames(
    ...
    """
    RWHAR npy: shape [N, num_sensors*win_samples]，Message [8632, 1050] = 21*50
    flatten Message sensor-major:
    ...
    Message raw：
      Message win_samples，
      Message“Message”（Message stride Message）。
    Message:
...
def _compute_mean_var_across_subjects(
    ...
    """
    Message raw Message（50Hz）Message mean/var。
    """
...
def ensure_all_loso_stats_json(
    ...
    """
    Message fold Message stats Message：
