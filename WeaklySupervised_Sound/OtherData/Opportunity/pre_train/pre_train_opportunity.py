...
def run_loso_pretrain(config: dict):
    ...
    Default: eval_loader uses test_ds (explicit train/test split).

    Optional: when val_mode="train_subject", sample one subject from Training subjects as val,
    while test_ds is still kept for final evaluation.
    """
