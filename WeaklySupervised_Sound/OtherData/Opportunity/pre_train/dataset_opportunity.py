...
class OpportunityDataset_3s(Dataset):
    """
    NPY-only Message Dataset：
    - Message processed/.../sbj_k.npy Message 30Hz raw [T,113]
    -  3s window (stride 50%)
    - window center frame Message GT Message -> MessagelabelMessagewindowMessagelabel_id
