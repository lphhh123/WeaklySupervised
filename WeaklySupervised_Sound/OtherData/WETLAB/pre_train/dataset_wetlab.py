...
class WetlabDataset_10s(Dataset):
    """
    Message Dataset：
    - Message processed/.../sbj_k.npy Message 50Hz raw [T,21]
    window center frame Message GT Message -> label_id
    - Message：Message raw/<stats_dirname>/loso_sbj_{fold}_stats.json（mean+var）
    """
    def __init__(
        self,
        dataset_dir: str,
