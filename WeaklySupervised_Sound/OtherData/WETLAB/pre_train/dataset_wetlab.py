...
class WetlabDataset_10s(Dataset):
    """
    Pretraining dataset:
    - Restore continuous 50Hz raw [T,21] from processed/.../sbj_k.npy
    - If the window center falls within a GT segment -> label_id
    - Normalize using raw/<stats_dirname>/loso_sbj_{fold}_stats.json (mean+var)
    """
    def __init__(
        self,
        dataset_dir: str,
