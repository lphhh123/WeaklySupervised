...
def get_segments_by_frames(probs, threshold=0.15, min_len=10):
    """
    probs: [T, C]
    Return frame indices within the window as [start_idx, end_idx, score].
    """
    T, C = probs.shape
...
def test_dual_logic(config, checkpoint_path, test_mode="test_full"):
    ...
    print(f"\n[{test_mode}] Frame-level matching evaluation...")
...
if __name__ == "__main__":
    ...
    if os.path.exists(best_ckpt):
        ...
        print("\nDone. Check the score recovery under Full mode.")
    else:
