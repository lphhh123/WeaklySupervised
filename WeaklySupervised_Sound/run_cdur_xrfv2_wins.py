...
def get_segments_by_frames(probs, threshold=0.15, min_len=10):
    """
    probs: [T, C]
    Message [start_idx, end_idx, score]
    """
    T, C = probs.shape
...
if __name__ == "__main__":
    config = {
        "path": {
            ...
            "checkpoint_path": "./checkpoints/xrfv2_cdur_loso",
            "result_path": "./result/xrfv2_cdur_loso"
        },
    ...
    print(f"-> Message: {total_params * 4 / (1024 ** 2):.2f} MB (Float32)")
    print("=" * 40 + "\n")
